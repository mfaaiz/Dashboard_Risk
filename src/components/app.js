...
import './app.css';
import FetchData from '../server/fetch_data';
                ...
                <div className="container-fluid">
                    <div className="row flex-xl-nowrap">
                        ...
                        <div id="nav" className="col-12 col-md-3 col-xl-2 bd-sidebar">
                            <div className="row">
                                <div className="col-md-12 col-8">
                                    <div className="text-sm-left text-md-center logo">Risk Dashboard</div>
                                </div>
                        ...
                        <div id="content-body" className="col-12 col-md-9 col-xl-10 pl-4 pr-4 bd-content">
                            {/* <!-- heading row --> */}
                            <div className="row">
                                <div className="col-md-12 pt-4 mt-3"><h2> Dashboard</h2></div>
                            </div>
                            {/* <!-- heading row end-->
